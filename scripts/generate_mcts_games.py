...
def generate_game(board_size, rounds, max_moves, temperature):
    ...
    encoder = get_encoder('oneplane', board_size)

    game = GameState.new_game(board_size, 7.5)

    bot = StandardMCTSAgent(rounds, temperature)
    ...
    while not game.is_over:
        ...
        if move.is_play:
            ...
            move_one_hot[encoder.encode_move(move.point)] = 1
