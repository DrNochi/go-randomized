...
from dlgo.neural.rl.experience import ExperienceCollector, combine_experience, load_experience
from dlgo.agents.neural.q import load_q_agent


def load_agent(filename):
    with h5py.File(filename, 'r') as h5file:
        return load_q_agent(h5file)
