...
from dlgo.neural.rl.experience import ExperienceCollector, load_experience, combine_experience
from dlgo.agents.neural.value import load_value_agent


def load_agent(filename):
    with h5py.File(filename, 'r') as h5file:
        return load_value_agent(h5file)
